 ...
 * $Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/mtd/ftl.c#1 $
 *
...
{
	DEBUG(0, "$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/mtd/ftl.c#1 $\n");
