/*
  ...
  $Header: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/scsi/osst.c#1 $";
