...
extern void check_memleak(const void *startAddr, const void *endAddr);
#endif
...
#ifdef CONFIG_KMALLOC_ACCOUNTING
        printk("\n****** REPORT FROM MEMORYLEAK TOOL for module ******** %s *****\n\n",mod->name);
        /*
         * Display memory leak information using the
         * kmallocacct database
         */
        check_memleak(mod->module_core, ((mod->module_core + mod->core_size) - 1));
        printk("\n");
#endif /* #ifdef CONFIG_KMALLOC_ACCOUNTING */
