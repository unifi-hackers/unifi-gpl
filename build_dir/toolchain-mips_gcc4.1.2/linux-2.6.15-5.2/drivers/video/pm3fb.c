 ...
 *  more details.
 *
 *  $Header: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/video/pm3fb.c#1 $
 *
 *  CHANGELOG:
...
int __init pm3fb_init(void)
{
	...
	DPRINTK(2, "This is pm3fb.c, CVS version: $Header: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/video/pm3fb.c#1 $");
