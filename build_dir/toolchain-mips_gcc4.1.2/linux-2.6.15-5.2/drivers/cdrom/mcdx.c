...
static const char *mcdx_c_version
    = "$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/cdrom/mcdx.c#1 $";
#endif
...
static int __init mcdx_init(void)
{
	...
	xwarn("$Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/cdrom/mcdx.c#1 $\n");
