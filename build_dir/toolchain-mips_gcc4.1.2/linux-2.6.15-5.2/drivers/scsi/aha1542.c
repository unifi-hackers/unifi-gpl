/* $Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/scsi/aha1542.c#1 $
...
/*
   static const char RCSid[] = "$Header: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/scsi/aha1542.c#1 $";
 */
