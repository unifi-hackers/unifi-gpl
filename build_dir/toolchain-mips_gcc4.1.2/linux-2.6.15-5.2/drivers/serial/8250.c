 ...
 *
 *  $Id: //depot/sw/releases/7.3_AP/linux/kernels/mips-linux-2.6.15/drivers/serial/8250.c#2 $
 *
...
static int __init serial8250_init(void)
{
	...
	printk(KERN_INFO "Serial: 8250/16550 driver $Revision: #2 $ "
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Generic 8250/16x50 serial driver $Revision: #2 $");
